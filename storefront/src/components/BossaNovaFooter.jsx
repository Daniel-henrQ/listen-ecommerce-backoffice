...
function BossaNovaFooter() {
    return (
        <footer className={`${styles.footerBase} ${styles.bossaNovaFooter}`}>
            <div className={styles.footerContainer}>
                {/* (O conteúdo interno é idêntico ao do RockFooter) */}
...
export default BossaNovaFooter;